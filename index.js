const users = [
  ...
  for (let user of users){
    themessage += ("ID : " + user.id  + "  Name : " + user.name + "  Adress : " + user.address.city + "\n\n")
  }
  
  alert(themessage);
  let promptedUserID = Number(prompt("Enter the ID "));
  ...
  for(let user of users){
    ...
    message1 = message1 + ("The username: " + user.username + "\n\n")
  }
